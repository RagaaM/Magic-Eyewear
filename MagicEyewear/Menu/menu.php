<html>
<head>
<link rel="stylesheet" href="/MagicEyewear/Layout/menu.css?v=<?php echo time(); ?>">
    ...
    <div class="dropdown">
      ...
      <li><a href="/MagicEyewear/Products/Gallery/Eyeglasses.php">Eyeglasses</a></li>
        <div class="dropdown-content">
          ...
          <a href="/MagicEyewear/Products/Categories/Gender/Girls.php">Girls</a>
        </div>
      </div>
      <div class="dropdown">
     ...
     <li><a href="/MagicEyewear/Discover/FramesGuide/Guide.php">Frames Guide</a></li>
   </div>
    </ul>
